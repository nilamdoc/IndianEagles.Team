...
<?php }?>
<h3>Register with IndianEagles and Get Training</h3>
<div class="row">
...
<?=$this->form->create(null,array('class'=>'form-group','id'=>'Register', 'enctype'=>"multipart/form-data")); ?>
	...
	<input type="text" class="form-control" name="registerfor" id="registerfor" value="Get Training" readonly="readonly">
	Want to get registered as a <a href="/users/register">consultant</a>? Want to give training to <a href="/users/givetraining">consultants</a>?
	</div>
		<div class="row">
		<div class="col-md-6" align="left">
		<div class="form-group">
