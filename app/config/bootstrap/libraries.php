...
include_once ('/home/nilam/ModiCare.php');
/**
...
Libraries::add('TelegramBot',array( 	'bootstrap' => 'telegram_required.php' ));
Libraries::add('jpgraph', array( 	'bootstrap' => 'jpgraph_required.php' ));
Libraries::add('swiftmailer', array(	'bootstrap' => 'swift_required.php'));
Libraries::add('twilio', array(	'bootstrap' => 'sdk/Twilio/autoload.php'));
